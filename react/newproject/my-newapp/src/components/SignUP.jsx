...
export default function SignUP(){
    ...
    const validate=()=>{
        ...
        if(formData.upass !== formData.ucpass) newErrors.ucpass="Password and Confirm Password dose not match"
        if((formData.upass.length<8)) newErrors.upass="Password must be grater than 8 character length"
        return newErrors
    };
